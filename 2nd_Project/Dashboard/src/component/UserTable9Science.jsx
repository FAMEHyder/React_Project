  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredUsers = allUsers.filter((user) => user.Class === '9th science' || user.Class === '9th Science' || user.Class === '9 science'|| user.Class === '9 Sciences');
...
export default UserTable9Science;
