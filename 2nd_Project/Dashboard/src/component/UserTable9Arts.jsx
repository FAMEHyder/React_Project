  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredUsers = allUsers.filter((user) => user.Class === '9th arts' || user.Class === '9th Arts' || user.Class === '9 Arts' || user.Class === '9 arts'); // Filter users where Class is '9th arts'
