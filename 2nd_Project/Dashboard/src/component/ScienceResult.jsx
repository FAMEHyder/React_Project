...
const validationSchema = Yup.object({
  ...
  chemistry: Yup.number().required("It is required").min(0, "Minimum 0").max(100, "Maximum 100"),
  english: Yup.number().required("It is required").min(0, "Minimum 0").max(100, "Maximum 100"),
});
