  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        ...
        const filteredUsers = allUsers.filter((user) => user.Class === '10th arts' || user.Class === '10 arts' || user.Class === '10th Arts' || user.Class === '10 Arts'); // Filter users where Class is '9th arts'
